...
- **Clone the repo - git clone https://github.com/Akhil0632/blog.git**
- **Open the terminal and change the directory to the project directory - cd blog**
...
- **Install Node JS Production-ready optimized build - npm run build**
